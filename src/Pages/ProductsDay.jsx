...
import jewelleryImage from "../assets/jewellery-1.jpg";
    ...
    <div className="product-featured">
      ...
      <div className="showcase-wrapper has-scrollbar">
        <div className="showcase-container">
          <div className="showcase">
            <div className="showcase-banner">
              <img src={shampooImage} alt="shampoo, conditioner & facewash packs" className="showcase-img" />
            </div>
        ...
        <div className="showcase-container">
          <div className="showcase">
            <div className="showcase-banner">
              <img src={jewelleryImage} alt="Rose Gold diamonds Earring" className="showcase-img" />
            </div>
            <div className="showcase-content">
              <div className="showcase-rating">
                <ion-icon name="star"></ion-icon>
